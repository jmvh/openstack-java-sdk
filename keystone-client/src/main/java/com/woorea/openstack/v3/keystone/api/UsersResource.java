...
public class UsersResource {
	...
	public Delete delete(String id) {
        ...
        public Projects projects(String id) {
	...
	public class Delete extends OpenStackRequest<Void> {
        ...
        public class Projects extends OpenStackRequest<com.woorea.openstack.v3.keystone.model.Projects> {
            
            public Projects(String id) {
                super(client, HttpMethod.GET, new StringBuilder("/users/").append(id).append("/projects").toString(), null, com.woorea.openstack.v3.keystone.model.Projects.class);
            }
        }
